...
void Z3ExampleMgr::test5(){
    ...
    //  q = &(p->f0);
    addToSolver(q ==  getMemObjAddress("p->f0"));
    //  *q = 10;
    storeValue(q,getZ3Expr(10));
    //   r = &(p->f1);
    addToSolver(r ==  getMemObjAddress("p->f1"));
    //   *r = x;
    storeValue(r,x);
    //   y = *r;
...
void Z3ExampleMgr::test6(){
    ...
    addToSolver(b == 5);
    // if(a > 10)
    if(getEvalExpr(a >getZ3Expr(10)).is_true()){
    // b = a;
    addToSolver(a == b);
    }
    //  assert(b>=5);
